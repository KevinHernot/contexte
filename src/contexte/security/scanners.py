...
def scan_text(document_id: str, text: str, *, chunk_id: str | None = None) -> list[SecurityFinding]:
...
def scan_document_security(document: ContextDocument) -> list[SecurityFinding]:
...
def scan_chunk_security(chunk: ContextChunk) -> list[SecurityFinding]:
    findings = scan_text(chunk.document_id, chunk.text, chunk_id=chunk.id)
